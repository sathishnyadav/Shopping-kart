package com.testyantraglobal.shopping.shoppingkarttyapi.configuration;
...
public class ApplicationConfiguration {
	...
	public Docket getDocket() {
		...
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.testyantraglobal")).build().apiInfo(apiInfo)
